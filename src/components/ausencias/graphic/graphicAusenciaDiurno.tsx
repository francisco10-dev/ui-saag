...
import { IndicadorDiurnoPorFecha, IndicadorDiurnoPorHora } from './funtionsGraphic';
  ...
  useEffect(() => {
    ...
    filteredSolicitudes.forEach(solicitud => {
      ...
      if (solicitud.fechaInicio !== null && solicitud.fechaFin !== null && solicitud.horaInicio === null && solicitud.horaFin === null) {
        indicador = IndicadorDiurnoPorFecha(solicitud.fechaInicio!, solicitud.fechaFin!, cantidadActivos);
      } else if (solicitud.fechaInicio !== null && solicitud.fechaFin !== null && solicitud.horaInicio !== null && solicitud.horaFin !== null) {
        indicador = IndicadorDiurnoPorHora(solicitud.horaInicio!, solicitud.horaFin!, cantidadActivos);
      }
